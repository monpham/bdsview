(function (k, d) {
  ...
  function J(a, b, c) {
    ...
    var e = this.createCanvas(), g = e.canvas;
    e = e.context;
    var h = new d.SpriteMaterial({color: a, map: this.createCanvasTexture(g)});
  ...
  function y(a, b, c) {
    ...
    c = function (b) {
      if (this.material) {
        var e = b.image.width / b.image.height, c = new d.Vector3;
        ...
        this.scaleDownAnimation = (new m.Tween(this.scale)).to({x: c.x, y: c.y}, 500).easing(m.Easing.Elastic.Out);
        this.material.map = b;
        this.material.needsUpdate = !0
      }
    }.bind(this);
    this.showAnimation = (new m.Tween(this.material)).to({opacity: 1}, 500).onStart(this.enableRaycast.bind(this, !0)).easing(m.Easing.Quartic.Out);
    this.hideAnimation = (new m.Tween(this.material)).to({opacity: 0}, 500).onStart(this.enableRaycast.bind(this, !1)).easing(m.Easing.Quartic.Out);
  ...
  function ca(a, b) {
      ...
      if (!1 !== f.enabled) {
        ...
        switch (a.touches.length) {
          case 1:
            ...
            H = {pageX: a.touches[0].pageX, pageY: a.touches[0].pageY};
            f.update();
            break;
          case 2:
            if (!0 === f.noZoom) break;
    ...
    this.mouseButtons = {ORBIT: d.MOUSE.LEFT, ZOOM: d.MOUSE.MIDDLE, PAN: d.MOUSE.RIGHT};
    var f = this, D = new d.Vector2, k = new d.Vector2, m = new d.Vector2, r = new d.Vector2, W = new d.Vector2,
      q = new d.Vector2, t = new d.Vector3, A = new d.Vector3,
      u = new d.Vector2, y = new d.Vector2, z = new d.Vector2, V = 0, I = 0, B = 0, C = 0, E = 1, F = new d.Vector3,
      M = new d.Vector3, N = new d.Quaternion, O = 0, P = 0, H, U = !1, G, J, K, L,
      v = {NONE: -1, ROTATE: 0, DOLLY: 1, PAN: 2, TOUCH_ROTATE: 3, TOUCH_DOLLY: 4, TOUCH_PAN: 5}, w = v.NONE;
    this.target0 = this.target.clone();
    this.position0 = this.object.position.clone();
    this.zoom0 = this.object.zoom;
    var T = (new d.Quaternion).setFromUnitVectors(a.up, new d.Vector3(0, 1, 0)), Y = T.clone().inverse(),
      X = {type: "change"}, R = {type: "start"}, S = {type: "end"};
    ...
    this.domElement.addEventListener("mousedown",
      c, {passive: !1});
    this.domElement.addEventListener("mousewheel", h, {passive: !1});
    this.domElement.addEventListener("DOMMouseScroll", h, {passive: !1});
    this.domElement.addEventListener("touchstart", l, {passive: !1});
    this.domElement.addEventListener("touchend", Q, {passive: !1});
    this.domElement.addEventListener("touchmove", x, {passive: !1});
    window.addEventListener("keyup", p, {passive: !1});
    window.addEventListener("keydown", n, {passive: !1});
    this.update()
  }

  function da(a, b) {
    var c = this, e = {type: "change"}, g = 0, h = 0, p = 0;
    this.camera =
      a;
    ...
    this.connect = function () {
      ...
      c.domElement.addEventListener("touchstart", x, {passive: !1});
      c.domElement.addEventListener("touchmove", Q, {passive: !1});
      c.enabled = !0
    };
    ...
    this.update = function (a) {
      if (!1 !== c.enabled && c.deviceOrientation) {
        var b = c.deviceOrientation.alpha ? d.Math.degToRad(c.deviceOrientation.alpha) + c.alphaOffsetAngle : 0,
          ...
          p = c.screenOrientation ? d.Math.degToRad(c.screenOrientation) : 0, n = c.camera.quaternion,
          l = new d.Vector3(0, 0, 1), x = new d.Euler, Q = new d.Quaternion,
          k = new d.Quaternion(-Math.sqrt(.5), 0, 0, Math.sqrt(.5)), m = new d.Quaternion, r = new d.Quaternion;
  ...
  function ia(a) {
    ...
    var h = new d.Vector2(.441, .156),
      ...
      n = p.attributes.position.array, l = p.attributes.uv.array;
    ...
    h = new d.MeshBasicMaterial({map: g.texture});
    p = new d.Mesh(p, h);
    c.add(p);
  ...
  function ea(a) {
    ...
    a = b.container;
    var c = b.cameraFov, e = b.controlBar, g = b.controlButtons, h = b.viewIndicator, p = b.indicatorSize,
      n = b.enableReticle, l = b.reverseDragging, k = b.output, Q = b.scene, f = b.camera;
    b = b.renderer;
    var D = a.clientWidth, r = a.clientHeight;
    this.container = a;
  ...
  var ja = "^0.105.2".replace(/[^0-9.]/g, ""), E = {ORBIT: 0, DEVICEORIENTATION: 1},
    q = {UNKNOWN: 0, NORMAL: 1, CARDBOARD: 2, STEREO: 3}, C = {TAB: 0, SBS: 1}, t = {
    ...
    fa = {
      load: function (a, b, c, e) {
        ...
        g.addEventListener("progress", function (a) {
          if (a) {
            var b = a.loaded, e = a.total;
            a.lengthComputable && c({loaded: b, total: e})
          }
        });
  ...
  Y.prototype = Object.assign(Object.create(d.EventDispatcher.prototype), {
    setContainer: function (a) {
      ...
      var a =
        this.element, b = new d.VideoTexture(a);
      b.generateMipmaps = !1;
      ...
      if (this.element && this.element.videoWidth && this.element.videoHeight && this.scene) {
        ...
        a = a.clientHeight;
        var c = this.scene.background, e = this.element;
  ...
  Object.assign(F.prototype,
    {
      constructor: F, updateUniformByFormat: function (a, b) {
        this.format = a;
        var c = b.repeat.value;
        b = b.offset.value;
        var e = this.loffset, g = this.roffset;
        switch (a) {
          case C.TAB:
            c.set(1, .5);
            b.set(0, .5);
  ...
  J.prototype = Object.assign(Object.create(d.Sprite.prototype), {
    constructor: J, setColor: function (a) {
      ...
      var b = this.context, c = this.canvasWidth, e = this.canvasHeight, g = this.material, h = this.dpr,
        d = a * Math.PI * 2, n = this.color.getStyle(), l = .5 * c / h;
      h = .5 * e / h;
      b.clearRect(0, 0, c, e);
      b.beginPath();
      ...
      var a = this, b = this.context, c = this.canvasWidth, e = this.canvasHeight, g = this.material,
        h = this.rippleDuration, d = performance.now(), n = this.color, l = this.dpr, k = .5 * c / l, m = .5 * e / l,
        f = function () {
          var p = window.requestAnimationFrame(f),
            x = (performance.now() - d) / h, q = 0 < 1 - x ? 1 - x : 0, r = x * c * .5 / l;
          b.clearRect(0, 0, c, e);
          b.beginPath();
          ...
          b.fill();
          b.closePath();
          1 <= x && (window.cancelAnimationFrame(p), a.updateCanvasArcByProgress(0), a.dispatchEvent({type: "reticle-ripple-end"}));
          g.map.needsUpdate = !0
        };
  ...
  var m = function (a, b) {
    ...
    c.Tween.prototype = {
      ...
      duration: function (a) {
        ...
        for (var b in this._valuesEnd) {
          ...
          void 0 !== this._object[b] && (this._valuesStart[b] = this._object[b], !1 === this._valuesStart[b] instanceof
        ...
        for (b in this._valuesEnd) if (void 0 !== this._valuesStart[b]) {
          var d = this._valuesStart[b] ||
            0, l = this._valuesEnd[b];
    ...
    c.Interpolation = {
      Linear: function (a, b) {
        var e = a.length - 1, g = e * b, d = Math.floor(g), l = c.Interpolation.Utils.Linear;
        ...
        var e = a.length - 1, g = e * b, d = Math.floor(g), l = c.Interpolation.Utils.CatmullRom;
  ...
  y.prototype = Object.assign(Object.create(d.Sprite.prototype), {
    constructor: y, setContainer: function (a) {
      if (a instanceof HTMLElement) var b = a; else a && a.container && (b = a.container);
      ...
      if (this.getContainer()) {
        var b = this.cursorStyle || (this.mode === q.NORMAL ? "pointer" : "default"), c = this.scaleDownAnimation,
          e = this.scaleUpAnimation, g = this.element;
        this.isHovering = !0;
      ...
      a = void 0 === a ? 0 : a;
      var b = this.hideAnimation, c = this.showAnimation, e = this.material;
      this.animated ? (b.stop(), c.delay(a).start()) : (this.enableRaycast(!0), e.opacity = 1)
    }, hide: function (a) {
      a = void 0 === a ? 0 : a;
      var b = this.hideAnimation, c = this.showAnimation,
        e = this.material;
  ...
  L.prototype = Object.assign(Object.create(d.EventDispatcher.prototype),
    {
      constructor: L, addControlBar: function () {
        ...
        return [{
          ...
          title: "Mode",
          subMenu: [{title: "Normal", handler: b("disableEffect")}, {
            title: "Cardboard",
            handler: b("enableEffect", q.CARDBOARD)
          }, {title: "Stereoscopic", handler: b("enableEffect", q.STEREO)}]
        }]
        ...
        var b = this, c = !1, e = !0, g = this.container;
        ...
        m.addEventListener("mousedown", a, {passive: !0});
        ...
        function b(a) {
          a.preventDefault();
          a.stopPropagation();
          var b = c.mainMenu, e = this.subMenu;
          b.hide();
          b.slideAll();
        ...
        a = void 0 ===
        a ? {} : a;
        var b = this, c = a.element || document.createElement("span"), e = a.onDispose;
        c.style.cursor = "pointer";
        c.style.float = "right";
        c.style.width = "44px";
        c.style.height = "100%";
  ...
  var ka = {
    tEquirect: {value: new d.Texture},
    repeat: {value: new d.Vector2(1, 1)},
    offset: {value: new d.Vector2(0, 0)},
    opacity: {value: 1}
  };
  r.prototype = Object.assign(Object.create(d.Mesh.prototype), {
    constructor: r, createGeometry: function (a) {
      ...
      a instanceof y && ((b = this.container) && a.dispatchEvent({
        ...
        type: "panolens-infospot-focus", method: function (a, b, d) {
          this.dispatchEvent({type: "panolens-viewer-handler", method: "tweenControlCenter", data: [a, b, d]})
        }.bind(this)
      }));
      ...
      if (a instanceof HTMLElement) var b =
        a; else a && a.container && (b = a.container);
      b && (this.children.forEach(function (a) {
        a instanceof y && a.dispatchEvent && a.dispatchEvent({type: "panolens-container", container: b})
      }), this.container = b)
    }, onLoad: function () {
      this.loaded = !0;
      ...
      this.traverse(function (a) {
        a instanceof y && (c ? a.show(b) : a.show(b))
      });
      ...
      console.log(this.linkedSpots);
      this.visible = !0;
      b ? (c = void 0 !== c ? c :
        void 0 !== a.linkingImageScale ? a.linkingImageScale : 300, e = e ? e : a.linkingImageURL ? a.linkingImageURL : t.Arrow, e = new y(c, e), e.position.copy(b), e.toPanorama = a, e.addEventListener("click", function () {
        this.dispatchEvent({type: "panolens-viewer-handler", method: "setPanorama", data: a})
      }.bind(this)), this.linkedSpots.push(e), this.add(e), this.visible =
        !0) : console.warn("Please specify infospot position for linking")
      console.log(a);
      // this.toggleInfospotVisibility();
      // a.autoHideInfospot;
    }, reset: function () {
      console.log('reset');
      this.linkedSpots = [];
  ...
  u.prototype = Object.assign(Object.create(r.prototype), {
    constructor: u, load: function (a) {
      a = a || this.src;
      if (!a) console.warn("Image source undefined"); else if ("string" === typeof a) K.load(a, this.onLoad.bind(this), this.onProgress.bind(this), this.onError.bind(this)); else if (a instanceof HTMLImageElement) this.onLoad(new d.Texture(a))
    }, onLoad: function (a) {
  ...
  M.prototype = Object.assign(Object.create(r.prototype),
    {
      constructor: M, createMaterial: function () {
        var a = d.ShaderLib.cube, b = a.fragmentShader, c = a.vertexShader;
  ...
  S.prototype = Object.assign(Object.create(M.prototype), {constructor: S});
  z.prototype = Object.assign(Object.create(r.prototype), {
    constructor: z, isMobile: function () {
      var a = !1, b = window.navigator.userAgent || window.navigator.vendor || window.opera;
      ...
      var a = this.options, b = a.muted, c = a.loop, e = a.autoplay, d = a.playsinline;
      a = a.crossOrigin;
      var h = this.videoElement, k = this.onProgress.bind(this), m = this.onLoad.bind(this);
      h.loop = c;
      h.autoplay = e;
      h.playsinline = d;
      h.crossOrigin = a;
      ...
      d = function () {
        ...
        e && this.dispatchEvent({type: "panolens-viewer-handler", method: "updateVideoPlayButton", data: !1});
        this.isMobile() && (h.pause(),
          e && b ? this.dispatchEvent({
            type: "panolens-viewer-handler",
            method: "updateVideoPlayButton",
            data: !1
          }) : this.dispatchEvent({type: "panolens-viewer-handler", method: "updateVideoPlayButton", data: !0}));
        window.requestAnimationFrame(function () {
          k({loaded: 1, total: 1});
          m(a)
        })
      ...
      var a = this.videoElement, b = this.playVideo.bind(this),
        c = this.dispatchEvent.bind(this), e = function () {
          c({type: "play"})
        }, d = function (a) {
  ...
  Object.assign(Z.prototype, {
    constructor: Z, setProgress: function (a, b) {
      ...
      var a = this.widths[this._zoom], b = this.heights[this._zoom], c = this.maxW, e = this.maxH;
      this._wc = Math.ceil(a / c);
      this._hc = Math.ceil(b / e);
      for (var d = 0; d < this._hc; d++) for (var h = 0; h < this._wc; h++) {
      ...
      var e = this.maxW, d = this.maxH;
      a *= 512;
      b *= 512;
      var h = Math.floor(a / e), k = Math.floor(b / d);
      this._ctx[k *
      ...
      this._count = 0;
      this._total = a * b;
      for (var e = this._parameters.useWebGL, ImagePanoramad =
  ...
  aa.prototype = Object.assign(Object.create(u.prototype), {
    constructor: aa, load: function (a) {
  ...
  var la = {
    tDiffuse: {value: new d.Texture},
    resolution: {value: 1},
    transform: {value: new d.Matrix4},
    zoom: {value: 1},
    opacity: {value: 1}
  };
  B.prototype = Object.assign(Object.create(u.prototype), {
    constructor: B, add: function (a) {
      ...
      switch (a.touches && a.touches.length || 1) {
        case 1:
          var b = 0 <= a.clientX ? a.clientX :
            a.touches[0].clientX;
          a = 0 <= a.clientY ? a.clientY : a.touches[0].clientY;
          var c = .4 * d.Math.degToRad(b - this.userMouse.x), e = .4 * d.Math.degToRad(a - this.userMouse.y);
      ...
      var b = this.material.uniforms, c = .1 * this.size, e = 10 * this.size;
      b.zoom.value += a;
  ...
  ba.prototype = Object.assign(Object.create(B.prototype), {
    constructor: ba, onLoad: function (a) {
      this.updateTexture(a);
  ...
  T.prototype =
    Object.assign(Object.create(r.prototype), {
      constructor: T, onPanolensContainer: function (a) {
  ...
  ca.prototype = Object.assign(Object.create(d.EventDispatcher.prototype),
    {constructor: ca});
  da.prototype = Object.assign(Object.create(d.EventDispatcher.prototype), {constructor: da});
  var ma = function (a) {
  ...
  ea.prototype = Object.assign(Object.create(d.EventDispatcher.prototype), {
    constructor: ea, setupScene: function (a) {
      return a = void 0 === a ? new d.Scene : a
    }, setupCamera: function (a, b, c) {
      return c = void 0 ===
      c ? new d.PerspectiveCamera(a, b, 1, 1E4) : c
    }, setupRenderer: function (a, b) {
      a = void 0 === a ? new d.WebGLRenderer({alpha: !0, antialias: !1}) : a;
      console.log(b);
      var c = b.clientWidth * 6 / 10, e = b.clientHeight + 500;
      console.log(c);
    ...
    setupContainer: function (a) {
      ...
      a.style.width = "100%";
      a.style.height = "100%";
      document.getElementById("vrImage-container").appendChild(a);
      ...
      a instanceof T && a.dispatchEvent({type: "panolens-scene", scene: this.scene});
      ...
      var c = this.widget.mainMenu, e = c.children[0];
      c = c.children[1];
      if (void 0 !== a) {
        switch (a) {
          case 0:
    ...
    enableEffect: function (a) {
      ...
      this.panorama instanceof z && this.panorama.dispatchEvent({type: "video-toggle", pause: a})
    }, setVideoCurrentTime: function (a) {
      this.panorama instanceof z && this.panorama.dispatchEvent({type: "video-time", percentage: a})
    ...
    rotateControlUp: function (a) {
      ...
      a = e.left;
      e = e.up;
      var d = this.rotateControlLeft.bind(this), h = this.rotateControlUp.bind(this), k = {left: 0, up: 0}, n = 0,
        l = 0;
      this.tweenLeftAnimation.stop();
      this.tweenUpAnimation.stop();
      this.tweenLeftAnimation = (new m.Tween(k)).to({left: a}, b).easing(c).onUpdate(function (a) {
        d(a.left - n);
        n = a.left
      }).start();
      this.tweenUpAnimation = (new m.Tween(k)).to({up: e}, b).easing(c).onUpdate(function (a) {
        h(a.up - l);
        l = a.up
      }).start()
      ...
      this.dispatchEvent({type: "window-resize", width: e, height: d});
      this.scene.traverse(function (a) {
        a.dispatchEvent && a.dispatchEvent({type: "window-resize", width: e, height: d})
      })
      ...
      if (!a || !a.target || a.target.classList.contains("panolens-canvas")) if (a.preventDefault(), a = a.changedTouches && 1 === a.changedTouches.length ? this.onTap({
      ...
      var c = this.container.getBoundingClientRect(), d = c.top, g = this.container, h = g.clientHeight;
      ...
      if (this.panorama) {
        ...
        if ("click" === b) this.panorama.dispatchEvent({
          ...
          type: "click-entity",
          mouseEvent: a
        }), g && g.dispatchEvent && g.dispatchEvent({type: "click", mouseEvent: a}); else {
      ...
      this.scene.traverse(function (a) {
        if (a instanceof
          y && a.element && (this.hoverObject === a || "none" !== a.element.style.display || a.element.left && "none" !== a.element.left.style.display || a.element.right && "none" !== a.element.right.style.display)) if (this.checkSpriteInViewport(a)) {
